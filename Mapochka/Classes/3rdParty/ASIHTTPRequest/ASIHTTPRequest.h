...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	id downloadProgressDelegateReal;
...
typedef void(^RequestHandlerBlock)(ASIHTTPRequest *requestInstance, NSData *responseData, NSError *error);
@property (nonatomic, copy) RequestHandlerBlock handlerBlock;
